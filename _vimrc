...
command! Vimrc edit e:\software\my_vim\_vimrc
command! Source :source e:\software\my_vim\_vimrc
command! Proj :edit .\project_config.sh
command! Conf :edit E:\software\my_vim\vimfiles\bin\sync.sh

nmap <silent> <F7> :make -j<CR>
nmap <silent> <F8> :make clean<CR>

nmap <silent> <F9> :make libs -j
nmap <silent> <F10> :make clean_libs
...
set undofile
set undodir=E:\software\my_vim\vim_undos
